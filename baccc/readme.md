...
# 🎓 Prompting Intro for Higher Education Leaders – Bay Area Community College Consortium (BACCC) Edition

**Audience**: Bay Area Community College Consortium (BACCC) Administrators  
...
[Download Here](https://github.com/opsgility/copilot/raw/refs/heads/main/baccc/sample-data.zip) 
...
#### 📄 Attach the following file: `BACCC_EnrollmentTrends2024.txt` prior to submitting the prompts
...
- ✅ Best:
  ...
  ```plaintext
  Summarize this institutional research report for Bay Area Community College Consortium's Board of Trustees. Highlight strategic implications and key decision points.
  ```
...
- ⚠️ Better:
  ...
  ```plaintext
  Draft a memo announcing the new sustainability initiative at Bay Area Community College Consortium.
  ```

- ✅ Best:

  ```plaintext
  Write a 1-page internal memo from the Chancellor to department heads announcing Bay Area Community College Consortium's sustainability plan. Include timeline, impact, and who to contact.
  ```
...
- ⚠️ Better:
  ...
  ```plaintext
  Write a vision statement for Bay Area Community College Consortium's next 5 years.
  ```

- ✅ Best:

  ```plaintext
  As Chancellor of Bay Area Community College Consortium, write a 5-year strategic vision statement focusing on equity, enrollment, and digital transformation. Use an inspiring tone.
  ```
...
#### 📄 Attach the folloing sample file: `BACCC_FacultyGrantProposal.docx`
...
- ✅ Best:
  ...
  ```plaintext
  As a Dean at Bay Area Community College Consortium reviewing grant proposals, assess this draft for clarity, completeness, and funding potential. Suggest revisions and summarize strengths and weaknesses.
  ```
...
- ✅ Best:
  ...
  ```plaintext
  Write a warm, supportive email from the Bay Area Community College Consortium Provost to faculty introducing the new LMS. Include key dates, training availability, and support channels.
  ```
...
- ✅ Best:
  ```plaintext
  Create a 2-day offsite leadership retreat agenda for Bay Area Community College Consortium deans. Include team-building activities, keynote themes, and local venues.
  ```

#### 🖼️ Image Prompt:

```plaintext
Design a flyer image for a university leadership retreat with collaboration, nature, and BACCC branding.
```
...
#### 📄 Attach the following sample file: `BACCC_Budget2023to2024.xlsx`
...
- ✅ Best:
  ...
  ```plaintext
  Summarize key findings from this Bay Area Community College Consortium department budget spreadsheet for a trustee meeting. Highlight growth areas, cuts, and explain major items simply.
  ```

#### 📊 Chart Prompt:

```plaintext
Create a bar chart comparing Bay Area Community College Consortium departmental budgets from 2023 to 2024 with clear labels and color-coding.
```
