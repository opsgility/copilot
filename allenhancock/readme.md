...
# 🎓 Prompting Intro for Higher Education Leaders – Allan Hancock College Edition

**Audience**: Allan Hancock College Administrators  
...
[Download Here](https://github.com/opsgility/copilot/raw/refs/heads/main/allenhancock/student-data.zip) 
...
#### 📄 Attach the following file: `ahc_EnrollmentTrends2024.txt` prior to submitting the prompts
...
- ✅ Best:
  ...
  ```plaintext
  Summarize this institutional research report for Allan Hancock College's Board of Trustees. Highlight strategic implications and key decision points.
  ```
...
- ⚠️ Better:
  ...
  ```plaintext
  Draft a memo announcing the new sustainability initiative at Allan Hancock College.
  ```

- ✅ Best:

  ```plaintext
  Write a 1-page internal memo from the Chancellor to department heads announcing Allan Hancock College's sustainability plan. Include timeline, impact, and who to contact.
  ```
...
- ⚠️ Better:
  ...
  ```plaintext
  Write a vision statement for Allan Hancock College’s next 5 years.
  ```

- ✅ Best:

  ```plaintext
  As Chancellor of Allan Hancock College, write a 5-year strategic vision statement focusing on equity, enrollment, and digital transformation. Use an inspiring tone.
  ```
...
#### 📄 Attach the folloing sample file: `ahc_FacultyGrantProposal.docx`
...
- ✅ Best:
  ...
  ```plaintext
  As a Dean at Allan Hancock College reviewing grant proposals, assess this draft for clarity, completeness, and funding potential. Suggest revisions and summarize strengths and weaknesses.
  ```
...
- ✅ Best:
  ...
  ```plaintext
  Write a warm, supportive email from the ahc Provost to faculty introducing the new LMS. Include key dates, training availability, and support channels.
  ```
...
- ✅ Best:
  ```plaintext
  Create a 2-day offsite leadership retreat agenda for Allan Hancock College deans. Include team-building activities, keynote themes, and local venues.
  ```

#### 🖼️ Image Prompt:

```plaintext
Design a flyer image for a university leadership retreat with collaboration, nature, and Allan Hancock College branding.
```
...
#### 📄 Attach the following sample file: `ahc_Budget2023to2024.xlsx`
...
- ✅ Best:
  ...
  ```plaintext
  Summarize key findings from this Allan Hancock College department budget spreadsheet for a trustee meeting. Highlight growth areas, cuts, and explain major items simply.
  ```

#### 📊 Chart Prompt:

```plaintext
Create a bar chart comparing Allan Hancock College departmental budgets from 2023 to 2024 with clear labels and color-coding.
```
