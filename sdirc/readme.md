...
[Download Here](https://github.com/opsgility/copilot/raw/refs/heads/main/sdirc/sample-data.zip) 
...
#### 📄 Attach the following file: `SDIRC_EnrollmentTrends2024.txt` prior to submitting the prompts
...
#### 📄 Attach the folloing sample file: `SDIRC_FacultyGrantProposal.docx`
...
- ✅ Best:
  ...
  ```plaintext
  Write a warm, supportive email from the SDIRC Provost to faculty introducing the new LMS. Include key dates, training availability, and support channels.
  ```
...
#### 📄 Attach the following sample file: `SDIRC_Budget2023to2024.xlsx`
